...
![LingoRise high-level architecture](./images/architecture.png)
...
- **VNPay / MoMo / SePay sandboxes** — payment redirects and IPN callbacks
...
![Auth login flow](./images/auth-flow.png)
